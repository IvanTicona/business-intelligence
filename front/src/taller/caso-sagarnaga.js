...
export const modelo = [
  ...
  },
  {
    ...
    columnas: [
      ...
      { nombre: 'fecha_entrada', tipo: 'DATE' },
      { nombre: 'fecha_salida', tipo: 'DATE' },
...
export const pasos = [
  ...
  },
  {
    ...
    pista: 'Una tabla puede tener varias foráneas. Las fechas van con el tipo DATE: Postgres lo tiene de verdad, así que guardarlas como texto sería desaprovecharlo.',
